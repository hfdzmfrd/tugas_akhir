<?php namespace App\Http\Controllers;
	...
	class AdminPegawainondosenController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Total Pegawai','count'=>DB::table('pegawainondosen')->count(),'icon'=>'fa fa-camera','color'=>'success'];
