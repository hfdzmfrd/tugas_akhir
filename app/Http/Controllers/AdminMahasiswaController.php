<?php namespace App\Http\Controllers;
	...
	class AdminMahasiswaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "nim";
			$this->limit = "20";
			$this->orderby = "nim,desc";
			...
			$this->col[] = ["label"=>"Foto","name"=>"Foto","image"=>true,"width"=>"300"];
			...
			$this->form[] = ['label'=>'Umur','name'=>'Umur','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Total Mahasiswa','count'=>DB::table('mahasiswa')->count(),'icon'=>'fa fa-graduation-cap','color'=>'success'];
